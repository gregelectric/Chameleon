...
;;  Version: 1.1, Updated on 2010/6/8 at 12:37:13
...
IF(1)                                            ; Active High Digit Drive
   and  [Port_3_Data_SHADE],~LED7SEG_DigitMask
ELSE                                             ; Active Low Digit Drive
   or   [Port_3_Data_SHADE],LED7SEG_DigitMask
ENDIF
...
IF(1)                                            ; Active High Digit Drive
   or   [Port_3_Data_SHADE],A
ELSE                                             ; Active Low Digit Drive
   and  [Port_3_Data_SHADE],A
ENDIF
   mov  A,[Port_3_Data_SHADE]
   mov  reg[LED7SEG_DigitPortDR],A
