...
;  Global Symbols
;-----------------------------------------------
export  PWM8_WHITE_EnableInt
export _PWM8_WHITE_EnableInt
export  PWM8_WHITE_DisableInt
export _PWM8_WHITE_DisableInt
export  PWM8_WHITE_Start
export _PWM8_WHITE_Start
export  PWM8_WHITE_Stop
export _PWM8_WHITE_Stop
export  PWM8_WHITE_WritePeriod
export _PWM8_WHITE_WritePeriod
export  PWM8_WHITE_WritePulseWidth
export _PWM8_WHITE_WritePulseWidth
export  PWM8_WHITE_bReadPulseWidth
export _PWM8_WHITE_bReadPulseWidth
export  PWM8_WHITE_bReadCounter
export _PWM8_WHITE_bReadCounter

; The following functions are deprecated and subject to omission in future releases
;
export  bPWM8_WHITE_ReadPulseWidth    ; deprecated
export _bPWM8_WHITE_ReadPulseWidth    ; deprecated
export  bPWM8_WHITE_ReadCounter       ; deprecated
export _bPWM8_WHITE_ReadCounter       ; deprecated


AREA control_RAM (RAM,REL)
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_WHITE_EnableInt
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_WHITE_EnableInt:
_PWM8_WHITE_EnableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_WHITE_EnableInt_M
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_WHITE_DisableInt
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_WHITE_DisableInt:
_PWM8_WHITE_DisableInt:
   RAM_PROLOGUE RAM_USE_CLASS_1
   PWM8_WHITE_DisableInt_M
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_WHITE_Start
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_WHITE_WritePeriod
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_WHITE_WritePeriod:
_PWM8_WHITE_WritePeriod:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_WHITE_PERIOD_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_WHITE_WritePulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_WHITE_WritePulseWidth:
_PWM8_WHITE_WritePulseWidth:
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   reg[PWM8_WHITE_COMPARE_REG], A
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_WHITE_bReadPulseWidth
;
;  DESCRIPTION:
...
;    functions.
;
 PWM8_WHITE_bReadPulseWidth:
_PWM8_WHITE_bReadPulseWidth:
 bPWM8_WHITE_ReadPulseWidth:                     ; this name deprecated
_bPWM8_WHITE_ReadPulseWidth:                     ; this name deprecated
   RAM_PROLOGUE RAM_USE_CLASS_1
   mov   A, reg[PWM8_WHITE_COMPARE_REG]
   RAM_EPILOGUE RAM_USE_CLASS_1
   ret
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: PWM8_WHITE_bReadCounter
;
;  DESCRIPTION:
...
;        functions.
;
 PWM8_WHITE_bReadCounter:
_PWM8_WHITE_bReadCounter:
 bPWM8_WHITE_ReadCounter:                        ; this name deprecated
_bPWM8_WHITE_ReadCounter:                        ; this name deprecated
   ...
   mov   A, reg[PWM8_WHITE_COMPARE_REG]          ; Save the Compare register on the stack
   push  A                                       ;
   PWM8_WHITE_Stop_M                             ; Disable (stop) the PWM
   M8C_SetBank1                                  ;
   mov   A, reg[PWM8_WHITE_INPUT_REG]            ; save the clock input setting
   push  A                                       ;   on the stack (now 2 bytes) and ...
                                                 ;   hold the clock low:
   mov   reg[PWM8_WHITE_INPUT_REG], INPUT_REG_NULL
   M8C_SetBank0
                                                 ; Extract the Count via DR2 register
   mov   A, reg[PWM8_WHITE_COUNTER_REG]          ; DR2 <- DR0
   mov   A, reg[PWM8_WHITE_COMPARE_REG]          ; Stash the Count on the stack
   ...
   mov   reg[PWM8_WHITE_INPUT_REG], A            ;
   M8C_SetBank0                                  ;
   PWM8_WHITE_Start_M                            ;   then re-enable the PWM.
