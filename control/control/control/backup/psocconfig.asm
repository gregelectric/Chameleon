...
export LoadConfig_control
export _LoadConfig_control
...
export Port_5_Data_SHADE
export _Port_5_Data_SHADE
export Port_7_Data_SHADE
export _Port_7_Data_SHADE
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_3_Data_SHADE], 20h
	mov		[Port_4_Data_SHADE], 0h
	mov		[Port_5_Data_SHADE], 0h
	mov		[Port_7_Data_SHADE], 0h

	lcall	LoadConfig_control
	lcall	LoadConfigTBL_control_Ordered
...
;
;    Load configuration registers for control.
...
_LoadConfig_control:
 LoadConfig_control:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_control_Bank0
    mov     X, <LoadConfigTBL_control_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_control_Bank1
    mov     X, <LoadConfigTBL_control_Bank1
...
_Port_5_Data_SHADE:
Port_5_Data_SHADE:	BLK	1
_Port_7_Data_SHADE:
Port_7_Data_SHADE:	BLK	1
